...
export const PERMISSION_CATALOG = [
  ...
  { key: 'requests.claim', description: 'Tomar solicitudes sin responsable asignado.' },
  { key: 'customer.portal.invite', description: 'Invitar o reenviar el acceso al portal del cliente.' },
  ...
  { key: 'quotes.approval.override', description: 'Resolver una aprobación propia, ignorando la separación de funciones.' },
  ...
  { key: 'projects.read', description: 'Consultar proyectos autorizados y su handoff.' },
  { key: 'projects.create', description: 'Convertir una cotización aceptada en proyecto.' },
  { key: 'projects.manage', description: 'Administrar el checklist y responsable de un proyecto.' },
