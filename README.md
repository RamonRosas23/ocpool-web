...
- [Protocolo del piloto controlado T1](docs/runbooks/pilot-usability-protocol.md) — cohorte, guion de tareas, captura SEQ/SUS, rúbrica de severidad y criterio Go/No-Go.
