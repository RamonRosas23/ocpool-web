...
**Spec:** `docs/historicos/specs/2026-09-08-ocpool-customer-onboarding-design.md`
...
- [x] **Step 1: Add failing permission assertions**
...
- [x] **Step 2: Run the permission tests and verify failure**

  Run: `npx vitest run tests/unit/auth-permissions.test.ts tests/integration/customer-auth-invitation.test.ts --maxWorkers=1`

  Expected: FAIL because the permission and capability do not exist.

- [x] **Step 3: Add the permission and capability projection**
...
- [x] **Step 5: Commit the RBAC contract**
...
- [x] **Step 2: Run the focused auth integration suite and verify failure**

  Run: `npx cross-env RUN_DB_TESTS=1 npx vitest run tests/integration/customer-auth-invitation.test.ts --maxWorkers=1`

  Expected: FAIL because no invitation helper exists and the consumer rejects `INVITED`.

- [x] **Step 3: Implement the transaction helper and activation transition**
...
- [x] **Step 4: Run focused tests and typecheck**
  ...
  Run: `npx cross-env RUN_DB_TESTS=1 npx vitest run tests/integration/customer-auth-invitation.test.ts --maxWorkers=1` and `npm run typecheck`. Expected: PASS.

- [x] **Step 5: Commit the auth lifecycle**

  Run: `git add src/server/auth/service.ts src/server/modules/notifications/event-resolver.ts tests/integration/customer-auth-invitation.test.ts && git commit -m "feat: activate invited customers through magic link"`
...
- [x] **Step 3: Implement the locked service**
...
- [x] **Step 4: Implement the strict staff route**
...
- [x] **Step 6: Commit the service/API**
...
- [x] **Step 2: Run focused notification tests and verify failure**
...
- [x] **Step 3: Implement action-path and action-label payloads**
...
- [x] **Step 4: Run focused tests and full typecheck**

  Run the focused tests and `npm run typecheck`. Expected: PASS.

- [x] **Step 5: Commit notification safety**
...
- [x] **Step 1: Add failing E2E/UI tests**
...
- [x] **Step 3: Extend the protected projection and component**
...
- [x] **Step 4: Run E2E, lint and responsive checks**

  Run the opt-in E2E, `npm run lint`, and `git diff --check`. Expected: PASS.

- [x] **Step 5: Commit the staff onboarding UI**
...
- Modify: `docs/historicos/plans/2026-09-08-ocpool-customer-onboarding.md`

- [x] **Step 1: Update documentation in order**
...
- [x] **Step 2: Run the full gate in order**
...
- [x] **Step 3: Record evidence and remaining external risks**
...
- [x] **Step 4: Commit the phase close**
  ...
  Run: `git add README.md docs/runbooks PROJECT_STATUS.md docs/historicos/plans/2026-09-08-ocpool-customer-onboarding.md && git commit -m "docs: close customer onboarding phase"`
