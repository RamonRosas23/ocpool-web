...
**Spec:** `docs/historicos/specs/2026-09-08-ocpool-analytics-dashboard.md`
...
- [x] **Step 6: Commit.**
  ...
  ```powershell
  git add src/app/api/staff/dashboard/route.ts src/server/modules/analytics/service.ts tests/integration/analytics-api.test.ts README.md docs/historicos/plans/2026-09-08-ocpool-analytics-dashboard.md
...
- Modify: `docs/historicos/specs/2026-09-08-ocpool-analytics-dashboard.md` only if the implementation reveals a verified contract correction.
...
**Files:**
- Modify: `docs/historicos/plans/2026-09-08-ocpool-analytics-dashboard.md`
- Modify: `PROJECT_STATUS.md`
...
- [ ] **Step 4: Commit de cierre.**
  ...
  ```powershell
  git add docs/historicos/plans/2026-09-08-ocpool-analytics-dashboard.md PROJECT_STATUS.md
